...
void saveFrame(void)
{
	...
	//Bills
	KeyFrame[FrameIndex].movRotNaveX = movRotNaveX;
	KeyFrame[FrameIndex].movRotNaveY = movRotNaveY;
	KeyFrame[FrameIndex].movRotNaveZ = movRotNaveZ;
	KeyFrame[FrameIndex].movNaveX = movNaveX;
	KeyFrame[FrameIndex].movNaveY = movNaveY;
	KeyFrame[FrameIndex].movNaveZ = movNaveZ;
...
void resetElements(void)//-Resetear las posiciones 
{
	...
	//Bills
	movRotNaveX = KeyFrame[0].movRotNaveX;
	movRotNaveY = KeyFrame[0].movRotNaveY;
	movRotNaveZ = KeyFrame[0].movRotNaveZ;
	movNaveX = KeyFrame[0].movNaveX;
	movNaveY = KeyFrame[0].movNaveY;
	movNaveZ = KeyFrame[0].movNaveZ;
}
...

{
	...
	//Bills
	movRotNaveXinc = (KeyFrame[playIndex + 1].movRotNaveX - KeyFrame[playIndex].movRotNaveX) / i_max_steps;
	movRotNaveYinc = (KeyFrame[playIndex + 1].movRotNaveY - KeyFrame[playIndex].movRotNaveY) / i_max_steps;
	movRotNaveZinc = (KeyFrame[playIndex + 1].movRotNaveZ - KeyFrame[playIndex].movRotNaveZ) / i_max_steps;
	movNaveXinc = (KeyFrame[playIndex + 1].movNaveX - KeyFrame[playIndex].movNaveX) / i_max_steps;
	movNaveYinc = (KeyFrame[playIndex + 1].movNaveY - KeyFrame[playIndex].movNaveY) / i_max_steps;
	movNaveZinc = (KeyFrame[playIndex + 1].movNaveZ - KeyFrame[playIndex].movNaveZ) / i_max_steps;
}
...
int main()
{
	...
	//BILLS
	KeyFrame[0].movRotNaveX = 0.0f;  //Movernos en -X para que suba
	KeyFrame[0].movRotNaveY = 0.0f;
	KeyFrame[0].movRotNaveZ = 0.0f;
	KeyFrame[0].movNaveX = 0.0f;  //Mov en  -X para avanzar
	KeyFrame[0].movNaveY = 0.0f;
	KeyFrame[0].movNaveZ = 0.0f;

	KeyFrame[1].movRotNaveX = 0.0f;  //Movernos en -X para que suba
	KeyFrame[1].movRotNaveY = 0.0f;
	KeyFrame[1].movRotNaveZ = 0.0f;
	KeyFrame[1].movNaveX = 20.0f;  //Mov en  -X para avanzar
	KeyFrame[1].movNaveY = 0.0f;
	KeyFrame[1].movNaveZ = 0.0f;

	KeyFrame[2].movRotNaveX = 24.0f;  //Movernos en -X para que suba //-100
	KeyFrame[2].movRotNaveY = 0.0f;
	KeyFrame[2].movRotNaveZ = 0.0f;
	KeyFrame[2].movNaveX = 20.0f;  //Mov en  -X para avanzar
	KeyFrame[2].movNaveY = 0.0f;
	KeyFrame[2].movNaveZ = 0.0f;

	KeyFrame[3].movRotNaveX = 25.0f;  //Movernos en -X para que suba	//-134
	KeyFrame[3].movRotNaveY = 0.0f;
	KeyFrame[3].movRotNaveZ = 0.0f;
	KeyFrame[3].movNaveX = 30.0f;  //Mov en  -X para avanzar
	KeyFrame[3].movNaveY = 20.0f;
	KeyFrame[3].movNaveZ = 0.0f;

	KeyFrame[4].movRotNaveX = -22.0f;  //Movernos en -X para que suba  //-80.0
	KeyFrame[4].movRotNaveY = 0.0f;
	KeyFrame[4].movRotNaveZ = 0.0f;
	KeyFrame[4].movNaveX = -30.0f;  //Mov en  -X para avanzar
	KeyFrame[4].movNaveY = 20.0f;  //
	KeyFrame[4].movNaveZ = 0.0f;

	KeyFrame[5].movRotNaveX = -23.0f;  //Movernos en -X para que suba  //-80.0
	KeyFrame[5].movRotNaveY = 0.0f;
	KeyFrame[5].movRotNaveZ = 0.0f;
	KeyFrame[5].movNaveX = -20.0f;  //Mov en  -X para avanzar
	KeyFrame[5].movNaveY = 30.0f;  //Empezamos a descender
	KeyFrame[5].movNaveZ = 0.0f;

	KeyFrame[6].movRotNaveX = -26.0f;  //Movernos en -X para que suba
	KeyFrame[6].movRotNaveY = 0.0f;
	KeyFrame[6].movRotNaveZ = 00.0f;
	KeyFrame[6].movNaveX = -20.0f;  //Mov en  -X para avanzar
	KeyFrame[6].movNaveY = 20.0f;
	KeyFrame[6].movNaveZ = 0.0f;

	KeyFrame[7].movRotNaveX = -29.0f;  //Movernos en -X para que suba
	KeyFrame[7].movRotNaveY = 0.0f;
	KeyFrame[7].movRotNaveZ = 00.0f;
	KeyFrame[7].movNaveX = -20.0f;  //Mov en  -X para avanzar
	KeyFrame[7].movNaveY = 20.0f;
	KeyFrame[7].movNaveZ = 0.0f;

	KeyFrame[8].movRotNaveX = -360.0f;  //Movernos en -X para que suba  //La rotacion 
	KeyFrame[8].movRotNaveY = 0.0f;
	KeyFrame[8].movRotNaveZ = 0.0f;
	KeyFrame[8].movNaveX = -20.0f;  //Mov en  -X para avanzar
	KeyFrame[8].movNaveY = -10.0f;
	KeyFrame[8].movNaveZ = 0.0f;

	KeyFrame[9].movRotNaveX = -380.0f;  //Movernos en -X para que suba  //La rotacion  /-360
	KeyFrame[9].movRotNaveY = 0.0f;
	KeyFrame[9].movRotNaveZ = 20.0f;
	KeyFrame[9].movNaveX = -30.0f;  //Mov en  -X para avanzar
	KeyFrame[9].movNaveY = -25.0f;
	KeyFrame[9].movNaveZ = 0.0f;

	KeyFrame[10].movRotNaveX = -40.0f;  //Movernos en -X para que suba  //La rotacion  /-360
	KeyFrame[10].movRotNaveY = 0.0f;
	KeyFrame[10].movRotNaveZ = 20.0f;
	KeyFrame[10].movNaveX = -20.0f;  //Mov en  -X para avanzar
	KeyFrame[10].movNaveY = -10.0f;
	KeyFrame[10].movNaveZ = 0.0f;

	KeyFrame[11].movRotNaveX = -360.0f;  //Movernos en -X para que suba  //La rotacion  /360
	KeyFrame[11].movRotNaveY = 0.0f;
	KeyFrame[11].movRotNaveZ = 20.0f;
	KeyFrame[11].movNaveX = -30.0f;  //Mov en  -X para avanzar
	KeyFrame[11].movNaveY = -25.0f;
	KeyFrame[11].movNaveZ = 0.0f;
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//BILLS
		//model = glm::translate(glm::mat4(1.0f), glm::vec3(5.0f, 0.0f, 0.0f)); //Ubicacion de la nave en el mapa
		model = glm::translate(model, glm::vec3(0.0f + movNaveX, 0.0f + movNaveY, 0.0f + movNaveZ));  //Variables con las que se va a mover la nave
		//model = glm::rotate(model, glm::radians(-90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::rotate(model, glm::radians(movRotNaveX), glm::vec3(1.0f, 0.0f, 0.0f)); //Ubicacion de la nave en rotacion X
		model = glm::rotate(model, glm::radians(movRotNaveY), glm::vec3(0.0f, 1.0f, 0.0f));  //Ubicacion de la nave en rotacion Y
	    model = glm::rotate(model, glm::radians(movRotNaveZ), glm::vec3(0.0f, 0.0f, 1.0f));  //Ubicacion de la nave en rotacion Z
...
void animacion()
{
		...
		if (play)// Si ya está activa la animacion 
		{
			...
			else
			{
				...
				//Bills
				movRotNaveX += movRotNaveXinc;
				movRotNaveY += movRotNaveYinc;
				movRotNaveZ += movRotNaveZinc;
				movNaveX += movNaveXinc;
				movNaveY += movNaveYinc;
				movNaveZ += movNaveZinc;
				//Animación Goku
